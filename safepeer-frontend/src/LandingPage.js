...
const LandingPage = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-background text-textPrimary px-6">
            ...
            {/* Logo */}
            <img src={logo} alt="SafePeer Logo" className="w-40 mb-6" />

            {/* Welcome Message */}
            <h1 className="text-2xl font-fredoka text-textPrimary text-center">
                Welcome to SafePeer!
            </h1>
            ...
            <div className="w-full flex flex-col items-center mt-8 space-y-6">
                <Link to="/signup" className="w-10/12 md:w-80">
                    <button className="w-full py-4 text-lg bg-accent text-white rounded-full font-bold font-poppins shadow-md hover:bg-secondary transition">
                        Sign Up
                    </button>
                </Link>
